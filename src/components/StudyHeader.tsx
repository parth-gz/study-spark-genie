...
const StudyHeader: React.FC<StudyHeaderProps> = ({ messages, settings, onSettingsChange }) => {
  return (
    <div className="bg-white border-b shadow-sm py-3 px-4 sm:px-6 flex items-center justify-between">
      <div className="flex items-center gap-2">
        <Book className="h-6 w-6 text-study-primary" />
        <h1 className="text-xl font-semibold text-study-dark">Study Spark Genie</h1>
      </div>
      <div className="flex items-center gap-2">
